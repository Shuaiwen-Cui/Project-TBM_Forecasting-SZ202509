...
const FEATURE_CONFIG = [
    { id: 1, name: '贯入度', transmission: 'date119', unit: 'mm/rpm', status: 'found' },
    { id: 2, name: '推进区间的压力（上）', transmission: 'date15', unit: 'MPa', status: 'found' },
    { id: 3, name: '推进区间的压力（右）', transmission: 'date16', unit: 'MPa', status: 'found' },
    { id: 4, name: '推进区间的压力（下）', transmission: 'date17', unit: 'MPa', status: 'found' },
    { id: 5, name: '推进区间的压力（左）', transmission: 'date18', unit: 'MPa', status: 'found' },
    ...
    { id: 14, name: '推进油缸总推力', transmission: 'date11', unit: 'kN', status: 'found' },
    ...
    { id: 19, name: '推进平均速度', transmission: 'date77', unit: 'mm/min', status: 'found' },
    { id: 20, name: '刀盘转速', transmission: 'date75', unit: 'r/min', status: 'found' },
    { id: 21, name: '刀盘扭矩', transmission: 'date76', unit: 'kN·m', status: 'found' },
    { id: 22, name: 'No.1刀盘电机扭矩', transmission: 'date46', unit: '%', status: 'found' },
    { id: 23, name: 'No.2刀盘电机扭矩', transmission: 'date47', unit: '%', status: 'found' },
    { id: 24, name: 'No.3刀盘电机扭矩', transmission: 'date48', unit: '%', status: 'found' },
    { id: 25, name: 'No.4刀盘电机扭矩', transmission: 'date49', unit: '%', status: 'found' },
    { id: 26, name: 'No.5刀盘电机扭矩', transmission: 'date50', unit: '%', status: 'found' },
    { id: 27, name: 'No.6刀盘电机扭矩', transmission: 'date51', unit: '%', status: 'found' },
    { id: 28, name: 'No.7刀盘电机扭矩', transmission: 'date52', unit: '%', status: 'found' },
    { id: 29, name: 'No.8刀盘电机扭矩', transmission: 'date53', unit: '%', status: 'found' },
    { id: 30, name: 'No.9刀盘电机扭矩', transmission: 'date54', unit: '%', status: 'found' },
    { id: 31, name: 'No.10刀盘电机扭矩', transmission: 'date55', unit: '%', status: 'found' }
];
